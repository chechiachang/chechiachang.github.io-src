---
title: "Monitoring Gke With Elk - configmap"
subtitle: ""
summary: ""
authors: []
tags: []
...
data:
  filebeat.yml: |-
    ...
    filebeat.autodiscover:
      ...
      providers:
        ...
        - type: kubernetes
          ...
          templates:
            - condition:
                equals.kubernetes.container.image: "nginx-ingress-controller"
              config:
                - module: nginx
                  log:
                    input:
                      ...
                      containers.ids:
                        ...
                        - "*"
            - condition:
                equals.kubernetes.container.image: "redis"
              config:
                - module: redis
                  log:
                    input:
                      ...
                      containers.ids:
                        ...
                        - "*"
            - condition:
                equals.kubernetes.container.image: "kafka"
              config:
                - module: kafka
                  log:
                    input:
                      ...
                      containers.ids:
                        ...
                        - "*"
            - condition:
                equals.kubernetes.namespaces: default
              config:
                - type: docker
                  containers.ids:
                    #- "${data.kubernetes.container.id}"
    ...
    output.elasticsearch:
      ...
      ssl.certificate_authorities: ["/etc/elk/certificates/client-ca.cer"]
    
      # Certificate for SSL client authentication
      ssl.certificate: "/etc/elk/certificates/client.cer"
    
      # Client certificate key
      ssl.key: "/etc/elk/certificates/client.key"
