...
- 停用無用的 tools
  - VSCode Copilot Build-in 50+ tools，但實務上只用到 10+ 個
...
- 約 0.1 USD 的成本，3 TWD ($5.00/1Mtks)
{{% /note %}}
...
- 降低 Long Context 機率（>=272K tks 變成兩倍價格）
...
Dataset: 從 daily work tracing 的考古題
