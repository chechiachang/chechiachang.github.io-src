...
講者有多年 AI SDD 經驗，並實際應用在生產環境中。
講者會分析適合導入 AI SDD 的場景，並分享實際案例，幫助團隊快速評估是否適合導入 AI SDD。
本次演講會嘗試以 "I ship code I don't read"（全自動代碼生成）的方式，示範如何使用 Spec-kit 撰寫可執行規格，並將其整合到開發流程中，讓參與者能夠實際體驗 AI SDD 的威力。
